            ...
            {carouselItems.map((item, index) => (
              <div className="blocks" key={index}>
                ...
                >
                  ...
                  <div
                    className="button_header d-flex align-items-start flex-md-column"
                  >
                    <div
                    ...
                    <div className="sektor_label p-2 order-md-2 order-1 m-2">
                      <div
                        className=" card_headers vertical-text d-flex flex-row align-items-start "
                      >
                        <label className="sektor_label">AA</label>
                        <label className="sektor_label">{item}</label>
                      </div>
                      <div
