      ...
      <div className="row">
        ...
        <div className="col-12 col-md-5 order-1 order-md-2">
          <div className="d-flex align-items-center justify-content-end">
            <label className="form_label_1 m-4" style={{ textAlign: "right" }}>
              {PARAMATER1}
            </label>
          </div>
          <div>
            <label className="form_label_2 m-4" style={{ textAlign: "right" }}>
              {PARAMATER2}
            </label>
          </div>
          <div className="d-flex align-items-center justify-content-end justify-content-md-end pl-0">
